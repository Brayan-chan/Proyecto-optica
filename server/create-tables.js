...
// Exportamos la función para poder importarla en reset-database.js
export async function createTables() {
  ...
  const connection = await mysql.createConnection({
    ...
    database: 'optica_db' // Conecta directamente a la base de datos existente
  });
  ...
  try {
    ...
    // Lista de tablas a eliminar en orden correcto para evitar problemas de clave foránea
    const tablesToDrop = [
      'pagos',
      'detalles_venta',
      'ventas',
    ...
    console.log('✅ Tablas antiguas eliminadas correctamente');
...
// También ejecutamos la función directamente si este archivo se ejecuta solo
